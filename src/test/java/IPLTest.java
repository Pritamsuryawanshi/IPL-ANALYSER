...
public class IPLTest {
    ...
    @Test
    public void givenIplCSVFile_ShouldReturnTopBallingAverages() throws IOException {
        String SortedIPLData = iplAnalyser.LoadIplData(SortField.AVG, IPL_MOST_WKTS_CSV_FILE_PATH, IPLAnalyser.IPL.WICKETS_CSV);
        IPLDTO[] censusCSV = new Gson().fromJson(SortedIPLData, IPLDTO[].class);
